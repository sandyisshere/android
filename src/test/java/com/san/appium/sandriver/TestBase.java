...
public class TestBase extends SelBase  {
	...
	protected static final ExtentReports extent = ExtentReports.get(TestBase.class);
	String Device ="";
...
//	 appiumServer.stopServer();
	...
	public  void startTest(Method method) throws Exception {
	    ...
	    extent.startTest("TestCase",testName);
	}
	@AfterMethod
	...
	{
		extent.attachScreenshot(takeScreenShot(),"This is a sample screenshot without an accompanying log step");
